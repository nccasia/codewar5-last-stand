...
namespace Anthill.Utils
{
	public static class AntMath
	{
		...
		/// <summary>
		/// Returns a random fractional number from the specified range.
		/// </summary>
		/// <param name="aLower">The smallest value in the range.</param>
		/// <param name="aUpper">The largest value in the range.</param>
		/// <returns>Random fractional.</returns>
		...
		/// <summary>
		/// Compares the specified values with possible uncertainty.
		/// </summary>
		/// <param name="aValueA">First meaning.</param>
		/// <param name="aValueB">Second meaning.</param>
		/// <param name="aDiff">Error.</param>
